...
//  Compile: g++ -c -m64 -Wall -fno-pie -no-pie -o main.o main.cpp
...
int main(){
  cout << "Welcome to Random Products, LLC.\nThis software is maintained by Kaitlyn Lee." << endl;
  char* name;
  name = executive();
  cout << "Oh, " << name << ". We hope you enjoyed your arrays. Do come again." << endl;
  cout << "A zero will be returned to the operating system." << endl;
  return 0;
}
